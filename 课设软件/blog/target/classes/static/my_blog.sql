...
CREATE TABLE `tb_blog` (
  ...
  `blog_content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci COMMENT '博客内容',
  `blog_count` int(50) DEFAULT '0' COMMENT '访问数量',
  `blog_time` datetime(6) DEFAULT NULL COMMENT '发布时间',
  `blog_typeId` int(11) NOT NULL COMMENT '所属分类',
  PRIMARY KEY (`blog_id`) USING BTREE,
  KEY `blog_type_fk` (`blog_typeId`) USING BTREE,
...
CREATE TABLE `tb_blogger` (
  ...
  `blogger_introuductin` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '个性签名',
  `blogger_email` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '博主邮箱',
  `blogger_nickname` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '博主姓名',
  `blogger_phone` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '联系方式',
...
-- ----------------------------
INSERT INTO `tb_blogger` VALUES ('1', 'admin', '123456', '不断学习，不断进步', '2082878884@qq.com', 'YYcoder', '10086');
...
CREATE TABLE `tb_blogtag` (
  ...
  KEY `blog_tag_fk2` (`tag_id`) USING BTREE,
  KEY `blog_tag_fk1` (`blog_id`) USING BTREE,
...
CREATE TABLE `tb_comment` (
  ...
  KEY `comment_user_fk` (`user_id`) USING BTREE,
  KEY `comment_blog_fk` (`blog_id`) USING BTREE,
...
INSERT INTO `tb_comment` VALUES ('12', '23', '1', '还行吧', '2020-07-11 09:13:32.117000');
INSERT INTO `tb_comment` VALUES ('13', '23', '1', '我觉得还可以吧', '2020-07-11 09:14:03.012000');
...
INSERT INTO `tb_tag` VALUES ('4', '后台技术', '1', '2020-07-11 13:59:24.310000');
INSERT INTO `tb_tag` VALUES ('5', '学习', '1', '2020-07-11 13:59:32.655000');
...
CREATE TABLE `tb_user` (
  ...
  `user_email` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '用户邮箱',
  `user_phone` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '联系方式',
